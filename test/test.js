...
describe("Uniswap Contract", function () {
     ...
     beforeEach(async function () {
          ...
          const rouaddress = "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D";
          const rouabi = [
          ...
          UniswapV2Contract = await ethers.getContractAt(rouabi,rouaddress);
          const UniswapV2flash = await ethers.getContractFactory("Flashswap");
          UniswapV2flashContract = await UniswapV2flash.deploy(MyToken2.address, MyToken3.address, FactoryContract, UniswapV2Contract.address);
          await UniswapV2flashContract.deployed();
     })
     it("adding liquidity", async function () {
          //console.log(UniswapV2Contract);
          ...
          expect(await MyToken1.balanceOf(owner.address)).to.equal(80000 );
          expect(await MyToken2.balanceOf(owner.address)).to.equal(80000 );
          expect(await MyToken3.balanceOf(owner.address)).to.equal(75000 );
